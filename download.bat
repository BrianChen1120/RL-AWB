...
REM Download models from Dropbox
echo [1/6] Downloading NCC model...
curl -L -o models\NCC_model.zip "https://www.dropbox.com/scl/fi/b9sgxxeu481gr4znv5l63/NCC_model.zip?rlkey=664d2tqily9shzktn08npmqxh&st=9vt59fmj&dl=1"

echo [2/6] Downloading LEVI model...
curl -L -o models\LEVI_model.zip "https://www.dropbox.com/scl/fi/o6gsmpx9lpku082ybymou/LEVI_model.zip?rlkey=fbvn3e0xiu1g4q1cnjq0v0vhu&st=unqs9q6g&dl=1"

echo [3/6] Downloading Gehler model...
curl -L -o models\Gehler_model.zip "https://www.dropbox.com/scl/fi/2hhmgw7j597vxsmlir98t/Gehler_model.zip?rlkey=0cftcoptp9vk6abn2p7lwaa0g&st=v24ady0c&dl=1"

REM Download datasets from Google Drive
